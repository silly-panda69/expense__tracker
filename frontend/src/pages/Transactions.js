                                ...
                                <tr key={item._id} className='border-bottom'>
                                    ...
                                    <td >
                                        <div className="dropdown">
                                            <button className='btn-sm drop-down-toggle'  id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
